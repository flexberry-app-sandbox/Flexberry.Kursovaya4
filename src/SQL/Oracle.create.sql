...
ALTER TABLE "Резервуар"
	ADD CONSTRAINT "Резервуар_FПо_1010" FOREIGN KEY ("Покупка") REFERENCES "Покупка" ("primaryKey");

CREATE INDEX "Резервуар_IПо_1392" on "Резервуар" ("Покупка");
